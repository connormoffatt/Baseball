...
weeks <- subset(data2011, BAT_ID == weeks.id & BAT_EVENT_FL == TRUE)
bourne <- subset(data2011, BAT_ID == bourne.id & BAT_EVENT_FL == TRUE)

# Print run values of each
sum(weeks$RUNS.VALUE)
sum(bourne$RUNS.VALUE)
